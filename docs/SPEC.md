...
- [1. 사용자 시나리오](#1-사용자-시나리오-user-scenario)
  - [1.0 전체 시나리오 개요](#10-전체-시나리오-개요-overview)
  - [1.1 홈 화면 (진입 허브)](#11-홈-화면-진입-허브)
  - [1.2 AI 러닝화 추천](#12-ai-러닝화-추천)
  - [1.3 대회 코스 기반 러닝화 추천](#13-대회-코스-기반-러닝화-추천)
  - [1.4 셀럽 / 우승자 착용 신발 탐색](#14-셀럽--우승자-착용-신발-탐색)
  - [1.5 러닝화 교체 시기 계산기](#15-러닝화-교체-시기-계산기)
  - [1.6 양말 색상 추천](#16-양말-색상-추천)
  - [1.7 러닝 코디 추천](#17-러닝-코디-추천)
  - [1.8 사이즈 핏 가이드](#18-사이즈-핏-가이드)
- [2. 타겟 단말](#2-타겟-단말-client)
- [3. 기술 스택](#3-기술-스택-tech-stack)
- [4. 시스템 구성도](#4-시스템-구성도-architecture)
- [5. 기능 요구사항](#5-기능-요구사항-functional-requirements)
  - [5.1 사용자 입력 폼 (프론트엔드)](#51-사용자-입력-폼-프론트엔드--v10)
  - [5.2 추천 엔진 및 LLM 연동 (백엔드)](#52-추천-엔진-및-llm-연동-백엔드--v10)
  - [5.3 홈 화면 허브 구조](#53-홈-화면-허브-구조-v20)
  - [5.4 셀럽 / 인플루언서 착용 신발](#54-셀럽--인플루언서-착용-신발-v20)
  - [5.5 신발에 어울리는 양말 색상 추천](#55-신발에-어울리는-양말-색상-추천-v20)
  - [5.6 러닝 코디 추천 + 가상 코디 시각화](#56-러닝-코디-추천--가상-코디-시각화-v20)
  - [5.7 마라톤 대회 우승자 착용 신발](#57-마라톤-대회-우승자-착용-신발-v20)
...
- [6. API 명세](#6-api-명세-api-specifications)
  ...
  - [6.3 POST /api/recommend/race](#63-post-apirecommendrace--v20)
  - [6.4 GET /api/race-winners](#64-get-apirace-winners--v20)
  - [6.5 POST /api/shoes/lifespan](#65-post-apishoeslifespan--v20)
  - [6.6 GET /api/celebs](#66-get-apicelebs--v20)
  - [6.7 GET /api/celebs/:celeb_id](#67-get-apicelebsceleb_id--v20)
  - [6.8 POST /api/recommend/socks](#68-post-apirecommendsocks--v20)
...
- [7. 데이터 구조 (Google Sheets DB & ERD)](#7-데이터-구조-google-sheets-기반-db--erd)
  ...
  - [7.2 Sheet 2: Logs](#72-sheet-2-logs-사용자-이용-이력)
  - [7.3 Sheet 3: Celebs](#73-sheet-3-celebs-셀럽-착용-신발--v20-신규)
  - [7.4 Sheet 4: RaceWinners](#74-sheet-4-racewinners-대회-우승자-착용-신발--v20-신규)
  - [7.5 Sheet 5: Races](#75-sheet-5-races-대회-코스-정보--v20-신규)
  - [7.6 Sheet 6: SizeGuide](#76-sheet-6-sizeguide-브랜드별-사이즈-가이드--v20-신규)
- [8. 서비스 흐름도 (Call Flow)](#8-서비스-흐름도-call-flow)
  - [8.1 AI 러닝화 추천](#81-ai-러닝화-추천--12-대응)
  - [8.2 대회 코스 기반 러닝화 추천](#82-대회-코스-기반-러닝화-추천--13-대응)
  - [8.3 셀럽 착용 신발 탐색](#83-셀럽-착용-신발-탐색--14-셀럽-탭-대응)
  - [8.4 우승자 착용 신발 탐색](#84-우승자-착용-신발-탐색--14-우승자-탭-대응)
  - [8.5 러닝화 교체 시기 계산기](#85-러닝화-교체-시기-계산기--15-대응)
  - [8.6 양말 색상 추천](#86-양말-색상-추천--16-대응)
  - [8.7 러닝 코디 추천](#87-러닝-코디-추천--17-대응)
  - [8.8 사이즈 핏 가이드](#88-사이즈-핏-가이드--18-대응)
  - [8.9 Fallback 처리 (Claude API 장애 시)](#89-fallback-처리-claude-api-장애-시)

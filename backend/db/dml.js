...
const SAMPLE_RACES = [
  // ── 세계 주요 마라톤 (7개) ──────────────────────────────────
  { race_id: 'tokyo_full',   race_name: '도쿄 마라톤',   country: 'JP', city: '도쿄',   course_type: 'full', typical_month: 3,  race_date: '2027-03-07', avg_temp_celsius: 7,  surface_type: 'asphalt', elevation_gain_m: 85,  difficulty: 2, course_summary: '도심 평탄 코스, 저온, 세계기록급 속도 코스',             shoe_priority_hint: '경량, 반발력',      is_world_major: true,  is_active: true },
  { race_id: 'boston_full',  race_name: '보스턴 마라톤', country: 'US', city: '보스턴', course_type: 'full', typical_month: 4,  race_date: '2027-04-19', avg_temp_celsius: 10, surface_type: 'asphalt', elevation_gain_m: 165, difficulty: 4, course_summary: '전반 내리막 → 후반 Heartbreak Hill, 고도차 주의',     shoe_priority_hint: '안정성, 쿠션, 경량', is_world_major: true,  is_active: true },
  { race_id: 'paris_full',   race_name: '파리 마라톤',   country: 'FR', city: '파리',   course_type: 'full', typical_month: 4,  race_date: '2027-04-13', avg_temp_celsius: 13, surface_type: 'asphalt', elevation_gain_m: 68,  difficulty: 2, course_summary: '센강변 평탄, 선선한 날씨, 관광지 통과',               shoe_priority_hint: '경량, 쿠션',        is_world_major: true,  is_active: true },
  { race_id: 'berlin_full',  race_name: '베를린 마라톤', country: 'DE', city: '베를린', course_type: 'full', typical_month: 9,  race_date: '2026-09-27', avg_temp_celsius: 14, surface_type: 'asphalt', elevation_gain_m: 45,  difficulty: 1, course_summary: '세계 최고 속도 코스, 완전 평탄, 세계기록 최다 배출', shoe_priority_hint: '경량, 반발력',      is_world_major: true,  is_active: true },
  { race_id: 'chicago_full', race_name: '시카고 마라톤', country: 'US', city: '시카고', course_type: 'full', typical_month: 10, race_date: '2026-10-11', avg_temp_celsius: 12, surface_type: 'asphalt', elevation_gain_m: 32,  difficulty: 1, course_summary: '도심 루프형 평탄, 강한 바람 변수',                   shoe_priority_hint: '경량, 안정성',      is_world_major: true,  is_active: true },
  { race_id: 'newyork_full', race_name: '뉴욕 마라톤',   country: 'US', city: '뉴욕',   course_type: 'full', typical_month: 11, race_date: '2026-11-01', avg_temp_celsius: 9,  surface_type: 'asphalt', elevation_gain_m: 283, difficulty: 3, course_summary: '다리 5개 통과, 고저차 있음, 고도 누적 높음',         shoe_priority_hint: '안정성, 쿠션, 경량', is_world_major: true,  is_active: true },
  { race_id: 'sydney_full',  race_name: '시드니 마라톤', country: 'AU', city: '시드니', course_type: 'full', typical_month: 9,  race_date: '2026-09-20', avg_temp_celsius: 16, surface_type: 'mixed',   elevation_gain_m: 132, difficulty: 2, course_summary: '오페라하우스 피니시, 지속적인 오르막과 내리막',       shoe_priority_hint: '안정성, 쿠션',      is_world_major: false, is_active: true },
  // ── 국내 마라톤 (23개) ─────────────────────────────────────
  { race_id: 'seoul_full',      race_name: '대전 서울 마라톤',        country: 'KR', city: '서울',      course_type: 'full', typical_month: 3,  race_date: '2027-03-15', avg_temp_celsius: 8,  surface_type: 'asphalt', elevation_gain_m: 42,  difficulty: 1, course_summary: '광화문~잠수, 도심 평탄, 국내 최고 권위 및 기록 우수',   shoe_priority_hint: '경량, 반발력',      is_world_major: false, is_active: true },
  { race_id: 'jtbc_half',       race_name: 'JTBC 서울 마라톤',       country: 'KR', city: '서울',      course_type: 'half', typical_month: 11, race_date: '2026-11-08', avg_temp_celsius: 12, surface_type: 'asphalt', elevation_gain_m: 85,  difficulty: 2, course_summary: '상암~잠수, 전반 평탄 하반 완만 오르막, 한강변 포함', shoe_priority_hint: '쿠션, 안정성',      is_world_major: false, is_active: true },
  { race_id: 'chuncheon_full',  race_name: '춘천 마라톤',             country: 'KR', city: '강원 춘천', course_type: 'full', typical_month: 10, race_date: '2026-10-18', avg_temp_celsius: 13, surface_type: 'mixed',   elevation_gain_m: 156, difficulty: 3, course_summary: '의암호 순환, 가을 선선한 기온, 아름다운 단풍',       shoe_priority_hint: '쿠션, 안정성',      is_world_major: false, is_active: true },
  { race_id: 'gyeongju_full',   race_name: '경주 마라톤',             country: 'KR', city: '경북 경주', course_type: 'full', typical_month: 10, race_date: '2026-10-25', avg_temp_celsius: 15, surface_type: 'asphalt', elevation_gain_m: 105, difficulty: 2, course_summary: '역사 유적지 인근, 완만한 기복, 일부 구간 비포장',   shoe_priority_hint: '쿠션, 안정성',      is_world_major: false, is_active: true },
  { race_id: 'daegu_full',      race_name: '대구 마라톤',             country: 'KR', city: '대구',      course_type: 'full', typical_month: 4,  race_date: '2027-04-05', avg_temp_celsius: 16, surface_type: 'asphalt', elevation_gain_m: 78,  difficulty: 2, course_summary: '도심 루프형 코스, 봄 기온, 기록 단축에 용이',       shoe_priority_hint: '경량, 안정성',      is_world_major: false, is_active: true },
  { race_id: 'gongju_full',     race_name: '공주 백제 마라톤',        country: 'KR', city: '충남 공주', course_type: 'full', typical_month: 9,  race_date: '2026-09-06', avg_temp_celsius: 22, surface_type: 'asphalt', elevation_gain_m: 89,  difficulty: 2, course_summary: '금강변 국내 주로, 이른 가을 다소 더운 기온',       shoe_priority_hint: '쿠션, 통기성',      is_world_major: false, is_active: true },
  { race_id: 'gunsan_full',     race_name: '군산 새만금 국제 마라톤', country: 'KR', city: '전북 군산', course_type: 'full', typical_month: 4,  race_date: '2027-04-18', avg_temp_celsius: 12, surface_type: 'asphalt', elevation_gain_m: 28,  difficulty: 1, course_summary: '새만금 방조제 직선 코스, 강한 바닷바람 주의',       shoe_priority_hint: '경량, 안정성',      is_world_major: false, is_active: true },
  { race_id: 'incheon_full',    race_name: '인천 송도 국제 마라톤',   country: 'KR', city: '인천',      course_type: 'full', typical_month: 10, race_date: '2026-10-04', avg_temp_celsius: 14, surface_type: 'asphalt', elevation_gain_m: 52,  difficulty: 1, course_summary: '송도 도심 및 해안도로, 직선로 위주의 단조로운 코스', shoe_priority_hint: '경량, 쿠션',        is_world_major: false, is_active: true },
  { race_id: 'busan_full',      race_name: '부산 바다 마라톤',        country: 'KR', city: '부산',      course_type: 'full', typical_month: 10, race_date: '2026-10-11', avg_temp_celsius: 17, surface_type: 'asphalt', elevation_gain_m: 168, difficulty: 3, course_summary: '광안대교 등 해안 교량 위주, 고저차와 강한 바닷바람', shoe_priority_hint: '안정성, 쿠션',      is_world_major: false, is_active: true },
  { race_id: 'jeju_full',       race_name: '제주 감귤 국제 마라톤',   country: 'KR', city: '제주',      course_type: 'full', typical_month: 11, race_date: '2026-11-22', avg_temp_celsius: 14, surface_type: 'mixed',   elevation_gain_m: 178, difficulty: 3, course_summary: '해안 및 중산간 도로, 기복이 있으며 기온 변화 있음', shoe_priority_hint: '안정성, 쿠션',      is_world_major: false, is_active: true },
  { race_id: 'cheorwon_full',   race_name: '철원 DMZ 한탄강 마라톤', country: 'KR', city: '강원 철원', course_type: 'full', typical_month: 9,  race_date: '2026-09-13', avg_temp_celsius: 18, surface_type: 'mixed',   elevation_gain_m: 225, difficulty: 4, course_summary: '민통선 내부 통과, 한탄강 협곡 지역, 고저차 있음', shoe_priority_hint: '안정성, 쿠션',      is_world_major: false, is_active: true },
  { race_id: 'miryang_full',    race_name: '밀양 아리랑 마라톤',      country: 'KR', city: '경남 밀양', course_type: 'full', typical_month: 2,  race_date: '2027-02-07', avg_temp_celsius: 5,  surface_type: 'asphalt', elevation_gain_m: 62,  difficulty: 2, course_summary: '겨울 비수기 대회, 이른 봄 완연한 날씨, 국도 평탄', shoe_priority_hint: '경량, 쿠션',        is_world_major: false, is_active: true },
  { race_id: 'hapcheon_full',   race_name: '합천 벚꽃 마라톤',        country: 'KR', city: '경남 합천', course_type: 'full', typical_month: 4,  race_date: '2027-04-12', avg_temp_celsius: 13, surface_type: 'mixed',   elevation_gain_m: 96,  difficulty: 2, course_summary: '합강변 벚꽃길 주로, 봄날씨에 미세한 오르막 지속', shoe_priority_hint: '쿠션, 안정성',      is_world_major: false, is_active: true },
  { race_id: 'jinju_full',      race_name: '진주 남강 마라톤',        country: 'KR', city: '경남 진주', course_type: 'full', typical_month: 3,  race_date: '2027-03-21', avg_temp_celsius: 9,  surface_type: 'asphalt', elevation_gain_m: 71,  difficulty: 1, course_summary: '남강변 위주, 기복 적어 기록 달성에 유리',           shoe_priority_hint: '경량, 쿠션',        is_world_major: false, is_active: true },
  { race_id: 'goseong_full',    race_name: '고성 공룡 마라톤',        country: 'KR', city: '경남 고성', course_type: 'full', typical_month: 4,  race_date: '2027-04-26', avg_temp_celsius: 13, surface_type: 'asphalt', elevation_gain_m: 118, difficulty: 3, course_summary: '해안도로 중심, 굴곡진 해안의 고저차와 바닷바람',   shoe_priority_hint: '안정성, 쿠션',      is_world_major: false, is_active: true },
  { race_id: 'cheongju_full',   race_name: '청주 대청호 마라톤',      country: 'KR', city: '충북 청주', course_type: 'full', typical_month: 9,  race_date: '2026-09-06', avg_temp_celsius: 22, surface_type: 'mixed',   elevation_gain_m: 248, difficulty: 5, course_summary: '대청호반, 지속적인 급경사와 내리막 반복, 최고 난이도', shoe_priority_hint: '안정성, 쿠션',    is_world_major: false, is_active: true },
  { race_id: 'pohang_full',     race_name: '포항 해변 마라톤',        country: 'KR', city: '경북 포항', course_type: 'full', typical_month: 5,  race_date: '2027-05-17', avg_temp_celsius: 17, surface_type: 'asphalt', elevation_gain_m: 78,  difficulty: 2, course_summary: '동해안 해변도로, 5월 더운 기온과 바닷바람 교차',   shoe_priority_hint: '통기성, 경량',      is_world_major: false, is_active: true },
  { race_id: 'hangang_half',    race_name: '서울 한강 마라톤',        country: 'KR', city: '서울',      course_type: 'half', typical_month: 4,  race_date: '2027-04-19', avg_temp_celsius: 14, surface_type: 'asphalt', elevation_gain_m: 38,  difficulty: 1, course_summary: '한강 자전거도로, 평탄 코스, 기록 달성에 유리',     shoe_priority_hint: '경량, 반발력',      is_world_major: false, is_active: true },
  { race_id: 'boseong_half',    race_name: '보성 비차 마라톤',        country: 'KR', city: '전남 보성', course_type: 'half', typical_month: 5,  race_date: '2027-05-10', avg_temp_celsius: 18, surface_type: 'asphalt', elevation_gain_m: 93,  difficulty: 2, course_summary: '메밀꽃밭 인근 주로, 5월 더운 날씨',               shoe_priority_hint: '통기성, 쿠션',      is_world_major: false, is_active: true },
  { race_id: 'anseong_half',    race_name: '안성 팜성 마라톤',        country: 'KR', city: '경기 안성', course_type: 'half', typical_month: 4,  race_date: '2027-04-12', avg_temp_celsius: 13, surface_type: 'asphalt', elevation_gain_m: 82,  difficulty: 2, course_summary: '한천 인근 국도, 완만한 코스',                     shoe_priority_hint: '경량, 쿠션',        is_world_major: false, is_active: true },
  { race_id: 'hantangang_half', race_name: '한탄강 마라톤',           country: 'KR', city: '경기',      course_type: 'half', typical_month: 10, race_date: '2026-10-04', avg_temp_celsius: 15, surface_type: 'mixed',   elevation_gain_m: 198, difficulty: 4, course_summary: '한탄강 인근 산간 지역, 오르막과 내리막 반복',     shoe_priority_hint: '안정성, 쿠션',      is_world_major: false, is_active: true },
  { race_id: 'jeonju_half',     race_name: '전주 마라톤',             country: 'KR', city: '전북 전주', course_type: 'half', typical_month: 10, race_date: '2026-10-11', avg_temp_celsius: 16, surface_type: 'asphalt', elevation_gain_m: 55,  difficulty: 2, course_summary: '전주천변 및 구도심, 평탄 코스에 가을 기온',       shoe_priority_hint: '경량, 쿠션',        is_world_major: false, is_active: true },
  { race_id: 'daejeon_half',    race_name: '대전 마라톤',             country: 'KR', city: '대전',      course_type: 'half', typical_month: 4,  race_date: '2027-04-26', avg_temp_celsius: 14, surface_type: 'asphalt', elevation_gain_m: 48,  difficulty: 1, course_summary: '도심 순환로, 평탄한 코스',                       shoe_priority_hint: '경량, 반발력',      is_world_major: false, is_active: true },
];
